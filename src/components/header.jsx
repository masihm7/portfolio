...
export const Header=()=>{
    ...
    <button  onClick={() => window.open('https://drive.google.com/file/d/1MqvDYuhUEnrmLnDCJKRHHaRGqBEQ3F1c/view?usp=sharing', '_blank')} className="btn btn-theme btn-sm">Download CV</button>
  </header>
